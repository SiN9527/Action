    ...
    <div class="container mt-5">
        ...
        <form action="UpdateUser" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="userID" name="userID" readonly value="${user.userID}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="uOccupation" name="uOccupation" value="${user.uOccupation}">
            </div>
